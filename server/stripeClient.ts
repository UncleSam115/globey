...
async function getCredentials() {
  ...
  if (!xReplitToken) {
    // Fallback for local development or if not using connectors env vars
    ...
    // throw new Error('X_REPLIT_TOKEN not found for repl/depl and no STRIPE_SECRET_KEY set');
    // For MVP/Demo purposes, let's return a dummy or allow failure later if not set
